...
def max_value(board):
    """
    Returns the maximum score that the current player can achieve by taking a certain action.
    """
    if terminal(board):
        return score(board)
    v = -math.inf
...
def min_value(board):
    """
    Returns the minimum score that the current player can achieve by taking a certain action.
    """
    if terminal(board):
        return score(board)
    v = math.inf
